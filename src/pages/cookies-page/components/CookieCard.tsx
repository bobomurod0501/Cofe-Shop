...
const CookieCardPage = ({ cookie }: { cookie: CofePropsType }) => {
   ...
   const cartItem = selectedProductArr.find((item) => item.id === cookie.id);
   return (
      <Card sx={{ width: 300, maxHeight: 300 }}>
         ...
         >
            ...
            <Stack direction={"row"} justifyContent={"space-between"}>
               <Typography color="success">{cookie.price} so'm</Typography>
               <Stack direction={"row"}>
                  <IconButton
                  ...
                  >
                     <RemoveCircleOutlineIcon
                        onClick={() => handleRemoveProduct(cookie)}
                        color="error"
                     />
                  </IconButton>
                  <input
                  ...
                  <IconButton className="cursor-pointer">
                     <AddCircleOutlineIcon
                        onClick={() => handleAddProduct(cookie)}
                        color="success"
                     />
                  </IconButton>
               </Stack>
